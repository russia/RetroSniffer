...
namespace SnifferRetro.Helpers
{
    public sealed class Injector
    {
        ...
        public static string Inject(int processId, string dllPath)
        {
            ...
            if (loadLibraryA == IntPtr.Zero)
            {
                ...
                return @"Failed to find kernel32.dll";
            }
            ...
            {
                return @"Successfully created remote thread";
            }
        }
    }
}